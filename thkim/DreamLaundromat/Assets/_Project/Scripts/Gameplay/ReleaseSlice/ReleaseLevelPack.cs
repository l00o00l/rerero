...
namespace Thkim.DreamLaundromat.Gameplay.ReleaseSlice
{
    public sealed class ReleaseLevelPack
    {
        ...
        public static ReleaseLevelPack CreateDefault()
        {
            return new ReleaseLevelPack(new[]
            {
                ...
                FromRound(
                    ...
                    "candidate.baked.mood-basics",
                    1000,
                    CreateBakedMoodBasics1000,
                    7,
                    ReleaseDifficultyBand.Tutorial,
                ...
                FromRound(
                    ...
                    "candidate.baked.clean-clarity",
                    1000,
                    CreateBakedCleanClarity1000,
                    7,
                    ReleaseDifficultyBand.Easy,
                ...
                FromRound(
                    ...
                    "candidate.baked.compact-flow",
                    1000,
                    CreateBakedCompactFlow1000,
                    7,
                    ReleaseDifficultyBand.Medium,
                ...
                FromRound("DL-RS-015", "Mood Queue", "mood와 stability를 더 촘촘한 stream에서 판단한다.", "자동 생성 후보도 수동 레벨처럼 의도가 읽히는지 검증한다.", "Soothe와 Settle 중 지금 비용이 낮은 선택은 무엇일까?", "자동 생성 레벨은 warning이 누적되면 QA 후보로 격리해야 한다.", "candidate.baked.mood-basics", 1020, CreateBakedMoodBasics1020, 13, ReleaseDifficultyBand.Easy, Tags("generated", "soothe", "settle")),
                FromRound("DL-RS-016", "Clear Target", "Clean/Vivid 조건을 여러 꿈 후보 중에서 맞춘다.", "동일 목표 주문에서도 후보 선택이 달라지는지 확인한다.", "어떤 꿈을 목표 주문에 붙이는 편이 변환 수가 적을까?", "목표가 좁아질수록 실패 이유를 UI가 더 잘 설명해야 한다.", "candidate.baked.clean-clarity", 1030, CreateBakedCleanClarity1030, 13, ReleaseDifficultyBand.Medium, Tags("generated", "wash", "clarify")),
                ...
                FromRound("DL-RS-019", "Compact Refill", "작은 active 공간에서 꿈 유입 순서를 계속 관리한다.", "자동 후보의 branching과 storage ratio가 과하지 않은지 본다.", "지금 빈 slot을 만드는 행동이 다음 주문을 돕고 있을까?", "active slot이 적으면 실수 복구가 답답해질 수 있다.", "candidate.baked.compact-flow", 1051, CreateBakedCompactFlow1050, 13, ReleaseDifficultyBand.Hard, Tags("generated", "compact", "storage")),
                ...
                FromRound("DL-RS-027", "Generated Clean Room", "생성 후보에서 clean/clarity 퍼즐의 품질을 검증한다.", "weighted distribution과 solver metric이 release 후보를 걸러내는지 본다.", "현재 후보의 최저 비용 경로는 어느 꿈에서 시작할까?", "생성 후보는 사람이 재미와 판독성을 따로 봐야 한다.", "candidate.baked.clean-clarity", 1070, CreateBakedCleanClarity1070, 13, ReleaseDifficultyBand.Hard, Tags("generated", "qa", "clarify")),
                FromRound("DL-RS-028", "Generated Compact Room", "작은 공간 자동 후보를 QA report로 추적한다.", "공간 압박, 변환 수, branching이 함께 좋은 범위인지 본다.", "빈칸을 만드는 행동이 실제 puzzle decision인가?", "공간 퍼즐로 치우치면 Dream 상태 변화의 정체성이 약해진다.", "candidate.baked.compact-flow", 1080, CreateBakedCompactFlow1080, 13, ReleaseDifficultyBand.Expert, Tags("generated", "qa", "storage")),
        ...
        private static DynamicRoundDefinition CreateBakedMoodBasics1000()
        {
            return new DynamicRoundDefinition
            {
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Stable), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 1)
                },
                OrderDeck = new[]
                {
                    Order(new DynamicOrderRequirement(1, false, DreamTaint.Clean, true, DreamMood.Calm, false, DreamClarity.Blurry, true, DreamStability.Stable), 3)
                },
                Modifiers = Array.Empty<DynamicModifierDefinition>()
            };
        }

        private static DynamicRoundDefinition CreateBakedCleanClarity1000()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-004",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Vivid, DreamStability.Stable), 1),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 4)
                },
                OrderDeck = new[]
                {
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, true, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 4)
                },
                Modifiers = Array.Empty<DynamicModifierDefinition>()
            };
        }

        private static DynamicRoundDefinition CreateBakedCompactFlow1000()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-008",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2)
                },
                OrderDeck = new[]
                {
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, false, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 4),
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, true, DreamMood.Calm, false, DreamClarity.Blurry, true, DreamStability.Stable), 1)
                },
                Modifiers = Array.Empty<DynamicModifierDefinition>()
            };
        }

        private static DynamicRoundDefinition CreateBakedMoodBasics1020()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-015",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Stable), 1),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 3),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 1)
                },
                OrderDeck = new[]
                {
        ...
        private static DynamicRoundDefinition CreateBakedCleanClarity1030()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-016",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Vivid, DreamStability.Stable), 3),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2)
                },
                OrderDeck = new[]
                {
        ...
        private static DynamicRoundDefinition CreateBakedCompactFlow1050()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-019",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 1),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 4),
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 1)
                },
                OrderDeck = new[]
                {
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, false, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 3),
                    Order(new DynamicOrderRequirement(1, false, DreamTaint.Clean, true, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 1),
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, true, DreamMood.Calm, false, DreamClarity.Blurry, true, DreamStability.Stable), 1)
                },
                Modifiers = Array.Empty<DynamicModifierDefinition>()
            };
        ...
        private static DynamicRoundDefinition CreateBakedCleanClarity1070()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-027",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Vivid, DreamStability.Stable), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 1)
                },
                OrderDeck = new[]
        ...
        private static DynamicRoundDefinition CreateBakedCompactFlow1080()
        {
            return new DynamicRoundDefinition
            {
                RoundId = "DL-RS-028",
                ...
                DreamBag = new[]
                {
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Calm, DreamClarity.Blurry, DreamStability.Unsettled), 3),
                    Dream(new DynamicDreamAttributes(DreamTaint.Clean, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 1),
                    Dream(new DynamicDreamAttributes(DreamTaint.Nightmare, DreamMood.Anxious, DreamClarity.Blurry, DreamStability.Stable), 2)
                },
                OrderDeck = new[]
                {
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, false, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 2),
                    Order(new DynamicOrderRequirement(1, false, DreamTaint.Clean, true, DreamMood.Calm, true, DreamClarity.Vivid, true, DreamStability.Stable), 1),
                    Order(new DynamicOrderRequirement(1, true, DreamTaint.Clean, true, DreamMood.Calm, false, DreamClarity.Blurry, true, DreamStability.Stable), 2)
                },
                Modifiers = Array.Empty<DynamicModifierDefinition>()
            };
        }
